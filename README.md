...
- [vovk.ts](https://github.com/finom/vovk) - a compact, zero-dependency framework inspired by NestJS that constructs Next.js 13+ App Route Handlers from decorated classes
